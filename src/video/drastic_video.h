...
enum DRASTIC_GUI_INPUT_ENUM {
    DRASTIC_GUI_INPUT_UP=0, 
    DRASTIC_GUI_INPUT_DOWN,
    DRASTIC_GUI_INPUT_LEFT, 
    DRASTIC_GUI_INPUT_RIGHT,
    DRASTIC_GUI_INPUT_A,
    DRASTIC_GUI_INPUT_B,

    NUM_OF_DRASTIC_GUI_INPUT
};

enum DRASTIC_MENU_OPTIONS_ENUM {
    DRASTIC_MENU_OPTIONS_FRAME_SKIP_TYPE=0, 
    DRASTIC_MENU_OPTIONS_FRAME_SKIP_VALUE,
    DRASTIC_MENU_OPTIONS_SAFE_FRAME_SKIPPING, 
    DRASTIC_MENU_OPTIONS_SCREEN_ORIENTATION,
    DRASTIC_MENU_OPTIONS_SCREEN_SWAP,
    
    DRASTIC_MENU_OPTIONS_SHOW_SPEED,
    DRASTIC_MENU_OPTIONS_ENABLE_SOUND,
    DRASTIC_MENU_OPTIONS_FAST_FORWARD,
    DRASTIC_MENU_OPTIONS_MIRROR_TOUCHSCREEN,
    DRASTIC_MENU_OPTIONS_COMPRESS_SAVESTATES,
    
    DRASTIC_MENU_OPTIONS_SNAPSHOT_IN_SAVESTATES,
    DRASTIC_MENU_OPTIONS_ENABLE_CHEATS,
    DRASTIC_MENU_OPTIONS_UNCOMPRESS_ROMS,
    DRASTIC_MENU_OPTIONS_BACKUP_IN_SAVESTATES,
    DRASTIC_MENU_OPTIONS_SPEED_OVERRIDE,

    DRASTIC_MENU_OPTIONS_FIX_MAIN_2D_SCREEN,
    DRASTIC_MENU_OPTIONS_DISABLE_EDGE_MARKING,
    DRASTIC_MENU_OPTIONS_SLOT_2_DEVICE,
    DRASTIC_MENU_OPTIONS_HIGH_RESOLUTION_3D,
    DRASTIC_MENU_OPTIONS_THREADED_3D,
         
    DRASTIC_MENU_OPTIONS_USE_RAW_SAV_FORMAT,
    DRASTIC_MENU_OPTIONS_ROATE_DPAD,
    DRASTIC_MENU_OPTIONS_ROATE_BUTTONS,
    DRASTIC_MENU_OPTIONS_AUTO_SAVESTATE,
    DRASTIC_MENU_OPTIONS_AUTO_SAVESTATE_SLOT,

    DRASTIC_MENU_OPTIONS_DELETE_GAME_SPECIFIC_CONFIG,
    DRASTIC_MENU_OPTIONS_EXIT_SAVE_FOR_ALL_GAMES,    
    DRASTIC_MENU_OPTIONS_EXIT_SAVE_FOR_THIS_GAME,
    DRASTIC_MENU_OPTIONS_EXIT_WITHOUT_SAVING,
    NUM_OF_MENU_OPTIONS
};
